...
/*
    Write an arrow function called 'jsNinja' that returns the string: 'I am a JavaScript 
    ninja!'
*/
...
/*
    ...
    Brownie points if you use a ternary statement (only spend significant time on this 
...
//   console.log(compareNums(5, 8));
  ...
  const compareNums = (num1, num2) => num1 > num2 ? num1 : num1 = num2 ? num2 : num2;
...
console.log(bestMovie('Braveheart'));
